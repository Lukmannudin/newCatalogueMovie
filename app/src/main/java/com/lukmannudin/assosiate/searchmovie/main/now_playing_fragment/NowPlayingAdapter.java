...
import com.lukmannudin.assosiate.searchmovie.main.search_fragment.SearchAdapter;
...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.MovieViewHolder> {
    ...
    public NowPlayingAdapter(Context context, List<ResultsItem> results,int pageId) {
